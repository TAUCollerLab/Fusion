...
#' 
unsupervised_smart_lexicon_model <- function(input, output, session, work_env, updateProgress = NULL, 
  ...
  updateProgress(value = 0.7, detail = "creating smart lexicon")
  lex <- getLexicon(work_env$lexicon(),
                    work_env$classification_labels,
  ...
  updateProgress(value = 0.8, detail = "making predictions")
